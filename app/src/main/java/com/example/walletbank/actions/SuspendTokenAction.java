...
public class SuspendTokenAction extends WalletActionImpl {


    public SuspendTokenAction(CompletionCallback completionCallback,
                              Activity activity,
    ...
    protected String getName() {
        return ActionName.SUSPEND_TOKEN.name();
    }
    ...
    protected Sdk.SdkActionMessage buildSdkActionMessage() {
        return new Sdk.SdkActionMessage() {
            ...
            public void onMessage(Sdk.Response response) {
                ...
                if (!result.equalsIgnoreCase("600")) {
