...
public class SelectTokenAction extends WalletActionImpl {


    public SelectTokenAction(CompletionCallback completionCallback,
                             Activity activity,
    ...
    protected String getName() {
        return ActionName.SELECT_TOKEN.name();
    }
    ...
    protected Sdk.SdkActionMessage buildSdkActionMessage() {
        return new Sdk.SdkActionMessage() {
            ...
            public void onMessage(Sdk.Response response) {
                ...
                if (!result.equalsIgnoreCase("300")) {
